...
import {fakeManualLoop} from './mocks/fakeLoop';

chai.use(sinonChai);

// This is a spec for a mock.
describe('Mock fakeManualLoop should', () => {
  it('be a function',
    () => expect(fakeManualLoop).to.be.a('function'));

  it('return object', () => expect(fakeManualLoop()).to.be.an('object'));

  it('return nextFrame and getTime functions', () => {
    const {gameTime, nextFrame} = fakeManualLoop();
